...
class ParticleAnimation extends HTMLElement {
    constructor() {
      super();
    ...
    runAnimation() {
        ...
        function animation() {
            ...
            gsap.set(shadow.querySelector("#left-hand"), {
                x: 30,
                transformOrigin: "right center"
            });
            gsap.set(shadow.querySelector("#right-hand"), {
                x: -30,
            ...
            const eyesTl = gsap
                ...
                .to(shadow.querySelectorAll(".eyes"), {
                    opacity: 0,
                    duration: 0.1
                })
                .to(shadow.querySelectorAll(".eyes"), {
            ...
            const robotTl = gsap
                ...
                .to(
                    shadow.querySelector("#left-hand"),
                    {
                        x: 80
                    },
                    "right"
                ...
                .to(
                    shadow.querySelector("#charge"),
                    {
                        scaleX: 0.8
                    },
                    "right"
                )
                .to(shadow.querySelector("#right-hand"), {
                    rotation: 20,
                    repeat: 2,
                    yoyo: true,
                    ease: "power2.inOut",
                ...
                .to(
                    shadow.querySelector("#right-hand"),
                    {
                        x: -80
                    },
                    "left"
                )
                .to(shadow.querySelector("#left-hand"), {
                    rotation: -20,
                    repeat: 3,
                    yoyo: true,
                    ease: "power1.inOut",
            ...
            //left-top-circle
            gsap.set(shadow.querySelector("#left-top-circle"), {
                transformOrigin: "center",
                scale: 0
            });
    
            gsap.to(shadow.querySelector("#left-top-circle"), {
                transformOrigin: "center",
                scale: 1,
                fill: "#34496a",
                repeat: -1,
            ...
            //graph-left-btm
            gsap.to(shadow.querySelectorAll(".graph-circle-lb"), {
                rotation: 360,
                transformOrigin: "center",
                duration: 2,
                stagger: {
            ...
            const planetTl = gsap
                ...
                .set(shadow.querySelector("#planet-circle"), {
                    rotation: 10,
                    transformOrigin: "center"
                })
                .to(shadow.querySelector("#planet-circle"), {
                    rotation: -10,
                    transformOrigin: "center",
                    ease: "power1.inOut"
                });
            ...
            //circle-btm-graph
            gsap.to(shadow.querySelector("#graph-cir-1"), {
                rotation: 360,
                ease: "none",
            ...
            gsap.to(shadow.querySelector("#graph-cir-2"), {
                rotation: 360,
                ease: "none",
            ...
            gsap.to(shadow.querySelector("#graph-cir-3"), {
                rotation: 360,
                ease: "none",
            ...
            gsap.to(shadow.querySelector("#graph-cir-mid-2"), {
                scale: 1.5,
                ease: "sine.inOut",
                transformOrigin: "center",
                repeat: -1,
            ...
            //bottom-right-graph
            gsap.to(shadow.querySelector("#graph-left"), {
            ...
            gsap.to(shadow.querySelector("#graph-right"), {
            ...
            gsap.to(shadow.querySelectorAll(".circles-top"), {
                rotation: 360,
            ...
            gsap.to(shadow.querySelector("#circle-l"), {
                drawSVG: "20",
                repeat: -1,
                yoyo: true,
                ease: Bounce.easeOut,
            ...
            gsap.to(shadow.querySelector("#circle-m"), {
                drawSVG: "80 30",
                repeat: -1,
                yoyo: true,
                ease: Bounce.easeOut,
            ...
            gsap.to(shadow.querySelector("#circle-r"), {
                drawSVG: "0",
                repeat: -1,
                yoyo: true,
             ...
             * Left Display
             */
            gsap.to(shadow.querySelector("#left-display-display"), {
                y: 10,
                ease: "sine.inOut",
                repeat: -1,
                yoyo: true,
            ...
            gsap.to(shadow.querySelector("#left-display-shadow"), {
                scale: 1.1,
                transformOrigin: "center",
                ease: "sine.inOut",
                repeat: -1,
            ...
            const songTl = gsap
                ...
                .to(shadow.querySelectorAll("#left-display-display line"), {
                    stroke: "#34496a",
                    stagger: {
                        each: 0.5
                    }
            ...
            for (let i = 0; i < 3; i++) {
                let clone1 = shadow.querySelector("#note-1").cloneNode(true);
                let clone2 = shadow.querySelector("#note-2").cloneNode(true);
                ...
                shadow.querySelector("svg").appendChild(clone1);
                shadow.querySelector("svg").appendChild(clone2);
            }
    
            gsap.to(shadow.querySelectorAll(".notes"), {
             ...
             * Right Display
             */
            gsap.to(shadow.querySelector("#right-display-display"), {
                y: 10,
                ease: "sine.inOut",
                repeat: -1,
                yoyo: true,
            ...
            gsap.to(shadow.querySelector("#right-display-shadow"), {
                scale: 1.1,
                transformOrigin: "center",
                ease: "sine.inOut",
                repeat: -1,
            ...
            //graph-lines
            gsap.to(shadow.querySelector("#graph-line"), {
                x: -105,
                ease: "none",
                repeat: -1,
                duration: 2
            ...
            gsap.to(shadow.querySelector("#bar-1-top"), {
                morphSVG: "#bar-1-btm",
                repeat: -1,
                yoyo: true
            });
            gsap.to(shadow.querySelector("#bar-2-top"), {
                morphSVG: "#bar-2-btm",
                repeat: -1,
                yoyo: true,
                duration: 1.5
            });
            gsap.to(shadow.querySelector("#bar-3-top"), {
                morphSVG: "#bar-3-btm",
                repeat: -1,
                yoyo: true,
                duration: 2
            ...
            //btns
            gsap.to(shadow.querySelectorAll("#btns ellipse"), {
                fill: "#34496a",
                stagger: {
                    amount: 1,
                    grid: [4, 4],
            ...
            window.addEventListener("mousemove", (e) => {
                ...
                gsap.to(shadow.querySelector("#mid-display"), {
                    x: -mouseX * 10,
                    y: mouseY * 10
                });
    
                gsap.to(shadow.querySelector("#btm-display"), {
                    x: -mouseX * 20,
                    y: mouseY * 10
                });
            });
    
            shadow.getElementById("robot").addEventListener("click", () => {
                robotTl.pause();
        ...
        function init() {
            ...
            shadow.getElementById("webgl").appendChild(renderer.domElement);
        ...
        function objects() {
            // Canvas
            const canvas = shadow.querySelector("canvas.webgl2");
